...
try {
 ...
 $paths=@($snap,$candidate,(Join-Path $repo 'Cargo.lock'),(Join-Path $repo 'sdk\Cargo.lock'),(Join-Path $repo 'sdk\sdk-lock.json'),(Join-Path $repo 'sdk\bundle-manifest.json'),(Join-Path $repo 'sdk\ui-abi-fingerprint.json'),(Join-Path $repo 'sdk\snapshot\protected-dependency-closure.json'),(Join-Path $repo 'sdk\fixtures\rust-folder-size-visual-column\Cargo.lock'))
 $rollbackGitPaths=@('sdk/snapshot/approved-gpui.json','Cargo.lock','sdk/Cargo.lock','sdk/sdk-lock.json','sdk/bundle-manifest.json','sdk/ui-abi-fingerprint.json','sdk/snapshot/protected-dependency-closure.json','sdk/vendor/cargo-sources','sdk/fixtures/rust-folder-size-visual-column/Cargo.lock','vendor/gpui-ce')
