...
$rollbackGitPaths=@('sdk/snapshot/approved-gpui.json','Cargo.lock','sdk/Cargo.lock','sdk/sdk-lock.json','sdk/bundle-manifest.json','sdk/ui-abi-fingerprint.json','sdk/snapshot/protected-dependency-closure.json','sdk/fixtures/rust-folder-size-visual-column/Cargo.lock','vendor/gpui-ce')
