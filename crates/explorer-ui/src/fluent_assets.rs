...
fn fluent_path(name: &str) -> Option<&'static str> {
    Some(match name {
        ...
        "app-folder" => {
            "M5 6C5 5.44772 5.44772 5 6 5H8C8.55228 5 9 5.44772 9 6V8C9 8.55228 8.55228 9 8 9H6C5.44772 9 5 8.55228 5 8V6ZM8 6H6V8H8V6ZM5 12C5 11.4477 5.44772 11 6 11H8C8.55228 11 9 11.4477 9 12V14C9 14.5523 8.55228 15 8 15H6C5.44772 15 5 14.5523 5 14V12ZM8 12H6V14H8V12ZM12 5C11.4477 5 11 5.44772 11 6V8C11 8.55228 11.4477 9 12 9H14C14.5523 9 15 8.55228 15 8V6C15 5.44772 14.5523 5 14 5H12ZM12 6H14V8H12V6ZM11 12C11 11.4477 11.4477 11 12 11H14C14.5523 11 15 11.4477 15 12V14C15 14.5523 14.5523 15 14 15H12C11.4477 15 11 14.5523 11 14V12ZM14 12H12V14H14V12ZM5 2C3.34315 2 2 3.34315 2 5V15C2 16.6569 3.34315 18 5 18H15C16.6569 18 18 16.6569 18 15V5C18 3.34315 16.6569 2 15 2H5ZM3 5C3 3.89543 3.89543 3 5 3H15C16.1046 3 17 3.89543 17 5V15C17 16.1046 16.1046 17 15 17H5C3.89543 17 3 16.1046 3 15V5Z"
        }
        "menu" => {
            "M2 4.5C2 4.22386 2.22386 4 2.5 4H17.5C17.7761 4 18 4.22386 18 4.5C18 4.77614 17.7761 5 17.5 5H2.5C2.22386 5 2 4.77614 2 4.5ZM2 10C2 9.72386 2.22386 9.5 2.5 9.5H17.5C17.7761 9.5 18 9.72386 18 10C18 10.2761 17.7761 10.5 17.5 10.5H2.5C2.22386 10.5 2 10.2761 2 10ZM2.5 15C2.22386 15 2 15.2239 2 15.5C2 15.7761 2.22386 16 2.5 16H17.5C17.7761 16 18 15.7761 18 15.5C18 15.2239 17.7761 15 17.5 15H2.5Z"
        }
        "pin" => {
        ...
        "star" => {
            "M9.1 2.65a1 1 0 0 1 1.8 0l1.93 3.91 4.32.63a1 1 0 0 1 .55 1.7l-3.12 3.05.74 4.3a1 1 0 0 1-1.45 1.05L10 15.86l-3.87 2.03a1 1 0 0 1-1.45-1.05l.74-4.3-3.12-3.04a1 1 0 0 1 .55-1.71l4.32-.63L9.1 2.65Z"
        }
        _ => return None,
    })
}
