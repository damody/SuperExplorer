...
chrome-new-bookmark-toolbar-folder = 新增書籤工具列
...
chrome-sort-url = URL
chrome-sort-tags = 標記
chrome-sort-last-visited = 上次瀏覽時間
chrome-sort-visit-count = 瀏覽次數
chrome-sort-date-added = 新增日期
chrome-sort-date-modified = 上次修改時間
chrome-sort-date = 日期
chrome-back = 上一頁
chrome-forward = 下一頁
chrome-up = 上一層
