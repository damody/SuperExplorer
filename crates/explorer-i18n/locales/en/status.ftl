...
op-copy-route = Copy { $count } items | { $source } → { $destination }
op-move-route = Move { $count } items | { $source } → { $destination }
op-recycle-route = Recycle { $count } items | { $source }
op-permanent-delete-route = Permanently delete { $count } items | { $source }
op-gdrive-trash-route = Move { $count } items to Google Drive trash | { $source }
op-shortcut-route = Create shortcut for { $count } items | { $source }
