...
#### Scenario: Canonical address excludes username
- **WHEN** the user navigates to `sftp://root@45.32.49.125/home/linuxuser`
- **THEN** every persistable or display address SHALL be the credential-free form `sftp://45.32.49.125/home/linuxuser` and SHALL NOT contain `root@`
...
- **WHEN** the user submits `sftp://@45.32.49.125/`
- **THEN** navigation fails through the visible invalid-address path

#### Scenario: Multiple at-signs are rejected
